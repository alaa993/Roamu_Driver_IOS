        ...
        if indexPath.section == 0 {
            ...
            if #available(iOS 11.0, *) {
                ...
                userRef.observe(.value, with: { snapshot in
                    ...
                    //type = 0 => driver
                    //type = 1 => user
                    if (self.posts[indexPath.row].type == "1" && self.posts[indexPath.row].travel_id > 0)
                    {
                    ...
                    cell.set(post: self.posts[indexPath.row], CommentsNo: count, subStoryboard:self.storyboard!, subNavigationVC: self.navigationController!)
