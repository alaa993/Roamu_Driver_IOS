...
//                acceptButton.isHidden = true
    ...
    func sendRequests(with status:String){
        ...
        else
        {
            ...
            params = ["ride_id":rideDetail!.rideId,"status":status, "travel_id":rideDetail!.travelId, "travel_status":self.travel_status,"by":"driver"]//
        }
...
//                    self.backWasPressed()
    ...
    func sendPaymentRequests(with status:String){
        let params = ["ride_id":rideDetail!.rideId,"travel_id":rideDetail!.travelId, "payment_status":status,"by":"driver"]//"by":"driver"
        let headers = ["X-API-KEY":Common.instance.getAPIKey()]
