...
class Notification {
    ...
    init(id:String, text:String, uid:String, ride_id:String, readStatus:String, timestamp:Double) {
        self.id = id
        self.text = text
    ...
    static func parse(_ key:String, _ data:[String:Any]) -> Notification? {
        if let uid = data["uid"] as? String,
            ...
            return Notification(id: key, text: text, uid: uid, ride_id: ride_id, readStatus: readStatus, timestamp: timestamp)
        }
        return nil
    }
}
